...
export default function ContactPage() {
  ...
  return (
    <div className="font-sans text-gray-800 bg-white">
      ...
      {/* Contact Form Section - Placed first as per the image */}
...
<h2 className="text-3xl md:text-4xl font-bold text-[#6B4F3B] font-['Libre_Baskerville']">UNIT 01:</h2>      
      <div className="space-y-6 pt-5">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 font-serif">AK 305, Sector 6-C, Mehran Town, Korangi, Industrial Area, Karachi.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 font-serif">0321 8287151</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 font-serif">info@atozee.net</p>
          </div>
        </div>
...
<h2 className="text-3xl md:text-4xl font-bold pl-8 text-[#6B4F3B] font-['Comic_Neue']">
  UNIT 02:
</h2>      
      <div className="space-y-6 pl-8 pt-5">
        <div className="flex items-start  gap-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-800">Address:</h3>
            <p className="text-gray-600 font-serif">Plot E-34, North Western Industrial Zone, Port Qasim Authority, Karachi, Pakistan.</p>
          </div>
        </div>
  ...
  >
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full">
      ...
      <div>
        <input
          ...
          required
          placeholder="Name*"
          className="w-full px-4 md:px-8 py-4 md:py-6 text-base md:text-lg font-sans border border-white rounded-none focus:ring-1 focus:ring-[#D3B683] focus:border-[#D3B683] outline-none transition bg-gray-50 placeholder-gray-500"
        />
      </div>
    ...
    <div className="w-full">
      <textarea
        ...
        className="w-full px-4 md:px-8 py-4 md:py-6 text-base md:text-lg font-sans border border-white rounded-none focus:ring-1 focus:ring-[#D3B683] focus:border-[#D3B683] outline-none transition bg-gray-50 min-h-[100px] md:min-h-[120px] placeholder-gray-500"
      ></textarea>
    </div>
    ...
    <div className="pt-2 md:pt-4 w-full">
      <button
        type="submit"
        className="w-full px-6 md:px-11 py-4 md:py-6 text-base md:text-lg bg-black text-white font-medium rounded-none hover:bg-gray-950 transition duration-300 focus:outline-none focus:ring-1 focus:ring-[#6B4F3B]"
      >
        SUBMIT
      </button>
    </div>
