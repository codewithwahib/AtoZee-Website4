    ...
    const fetchData = async () => {
      try {
        const [
          ...
          client.fetch('*[_type == "abouthome1"][0] { image }'),
          client.fetch('*[_type == "abouthome2"] { image }'),
          client.fetch('*[_type == "abouthome3"] { image }'),
          client.fetch('*[_type == "abouthome4"] { image }')
        ]);
              ...
              {images.map((image, index) => (
                ...
                >
                  <Image
                    ...
                    alt={`Jubilee Corporation Team ${index + 1}`}
                    width={1920}
                    height={1280}
                    quality={100}
                    priority={index === 0}
